// hugeicons:hugeicons:undo-03
import { SVGProps } from "react";

export const CircleResetIcon = ({ ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
