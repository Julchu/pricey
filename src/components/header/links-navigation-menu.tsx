  ...
  return (
    <NavigationMenu.Root className="min-w-max text-neutral-950 dark:text-white">
        ...
        <NavigationMenu.Item>
          ...
          <NavigationMenu.Content className={guidesContentClassName}>
            <div className="flex flex-col gap-4 p-4 text-neutral-950 dark:text-white">
              <div>
                <h4 className="m-0 text-base leading-5 font-normal">
                  {guidesPanel.title}
                </h4>
              ...
              <ul className="m-0 -mx-2 flex list-none flex-col gap-0 p-0">
                {guideLinks.map((link) => (
                  <li key={link.href}>
                    <Link className={linkCardClassName} href={link.href}>
                      <h5 className="m-0 text-sm leading-4 font-normal">
                        {link.title}
                      </h5>
      ...
      <NavigationMenu.Portal>
        ...
        >
          <NavigationMenu.Popup className="relative h-[var(--popup-height)] w-[var(--popup-width)] origin-[var(--transform-origin)] border border-neutral-950 bg-white text-neutral-950 shadow-[0.25rem_0.25rem_0] shadow-black/12 transition-[opacity,transform,width,height,scale] duration-[var(--duration)] ease-[var(--easing)] outline-none data-ending-style:scale-90 data-ending-style:opacity-0 data-ending-style:transition-[opacity,scale] data-ending-style:duration-150 data-ending-style:ease-[ease] data-starting-style:scale-90 data-starting-style:opacity-0 dark:border-white dark:bg-neutral-950 dark:text-white dark:shadow-none">
